...
// You might notice that these tests do not actually assert anything.
// They just output the result of the binding to the console.
// With these tests, we get significantly better coverage, but
// when somebody has the time, adding assertions would be great.
